...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		<div class="row gx-lg-5">
			<div class="col-lg-12"><div class="cat-title"><?php echo $category[0]->name; ?></div></div>
			<div class="col-lg-6">
				...
				<?php
					$args = array(
						'prev_text' => '<svg width="21" height="14" viewBox="0 0 21 14" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M1 7.2791L17.8771 7.2791" stroke="#346139" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
						<path d="M11.9702 1.04684L19.5283 7.04535L11.9702 13.0439" stroke="#346139" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
						<span class="nav-subtitle">' . esc_html__( 'Previous Article', 'live' ) . '</span>',
						'next_text' => '<span class="nav-subtitle">' . esc_html__( 'Next Article', 'live' ) . '</span><svg width="21" height="14" viewBox="0 0 21 14" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M1 7.2791L17.8771 7.2791" stroke="#346139" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
						<path d="M11.9702 1.04684L19.5283 7.04535L11.9702 13.0439" stroke="#346139" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>',
					);
