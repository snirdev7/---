<?php
    /*
    ** Template for products category **
    */
    get_header();
	...
	$article_text   = get_field('article_text', $current_cat);
?>
<?php if ( $header_image ) : ?>
        ...
        <?php
            ...
            if ($products){
                foreach ($products as $p) {
                    ...
                    $weight     = get_field('weight', $p->ID);
                    $natural    = get_field('natural', $p->ID);
                    $organic    = get_field('organic', $p->ID);
                    $vegan      = get_field('vegan', $p->ID);
                    ?>
                    <div class="col-sm-6 col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <h4><?php echo $weight . ' ' . __('grams', 'live'); ?></h4>
                                <!-- Product Type -->
