...
?>
<div class="container">
    <div class="row blog-heading top-bar pt-3 pb-3">
    ...
    <?php
        ...
        if ($product_cats){
            echo '<div class="row all-recipes gy-4 g-lg-5">';
            foreach ($product_cats as $cat) {
                # fields...
                $cat_id     = $cat->term_id;
                $thumb      = get_field('hero_image', 'recipe-category_' . $cat->term_id );
                $cat_name   = $cat->name;
                ?>
                <div class="col-6 col-lg-4 recipe-item" data-title="<?php echo str_replace(' ', ' ',$cat_name);?>">
